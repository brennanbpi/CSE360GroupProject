...
public class backend
{
	...
	{
		int median;
		median = (allgrades.size()/2 + 0.5);	//Will take ceiling. Ex: 3/2 = 1.5 + 0.5 = 2 ; 4/2 = 2 + 0.5 = 2 becuase int drops .05
	...
	public float getMode()
	{
		...
		while(temp.size() != 0)
		{
			num = temp.get(1);						//Gets the float of the first index; will be different because original 1 gets removed.
